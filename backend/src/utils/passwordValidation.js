/**
 * Validación de contraseñas con restricciones de seguridad
 */

/**
 * Valida una contraseña según las políticas de seguridad
 * @param {string} password - La contraseña a validar
 * @returns {{ valid: boolean, error?: string, requirements?: object }}
 */
 ...
 * @param {object} validationResult - Resultado de validatePassword
 * @returns {string}
 */
export function getPasswordErrorMessage(validationResult) {
  ...
  return validationResult.error || 'La contraseña no cumple con los requisitos de seguridad';
}
